...
/**
 * This program will perform operations on a DoubleArraySeq based on the users
 * input.
 * 
 * @author Joe Cumbo
 * @since 10/7/2013
...
public class Menu {
    /*
     * The 'sequenceInstance' is the menus instance of the SequenceTest class. A
     * new
     ...
     * 
     * @param input The integer corresponding to the options in the displayMenu
     *        method.
     * @exception IllegalArgumentException If the corresponding option does not
     *            exist,
